...
const state = {
  ...
  baitisAnalysisMapData: [],//白塔寺分析数据
  baitasTab: 0,//白塔寺检测点下的tab切换，0代表是实时信息 1代表分析与可视化
  baitasPanelShow: false,//白塔寺检测点下的tab切换销毁对应的面板
  baitasPanShowDetail: null,//隐藏白塔寺分析面板
  baitasPanShowChart: null,//显示白塔寺统计图表
  baitisAnalysisChartData:null,//白塔寺分析图表数据
  baitisAnalysisTime: ["2017-12-15 00:00:00", "2017-12-15 23:00:00"],//白塔寺右侧详情的
  baitisAnalysisDetailData:[],//白塔寺详情数据
}
...
const mutations = {
  changeBaitisAnalysisDetailData(state,data){
    state.baitisAnalysisDetailData = data;
  },
  changeBaitisAnalysisTime(state,time){
    state.baitisAnalysisTime = time;
  },
  changeBaitisAnalysisChartData(state,data){
    state.baitisAnalysisChartData = data;  
  },
  changeBaitasPanShowChart(state,show){
    state.baitasPanShowChart = show;
  },
  changeBaitasPanShowDetail(state,show){
    state.baitasPanShowDetail = show;
  },
  changeBaitasPanelShow(state,isShow){
    state.baitasPanelShow = isShow;
  },
  changeBaitasTab(state,num){
    state.baitasTab = num;
  },
  changeBaitisAnalysisMapData(state,data){
    state.baitisAnalysisMapData = data;
  },
